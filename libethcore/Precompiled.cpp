...
bigint parseBigEndianRightPadded(bytesConstRef _in, bigint _begin, bigint _count)
{
...
namespace
{
	bigint expLengthAdjust(bigint _expOffset, bigint _expLength, bytesConstRef _in)
	{
		if (_expLength <= 32)
		{
